import { IDragSourceMonitor } from './drag-source-monitor';
...
export interface IDragSourceSpec<
  ...
  beginDrag(monitor: IDragSourceMonitor<void, void>): Item;
   ...
   */
  canDrag?(monitor: IDragSourceMonitor<void, void>): boolean;
   ...
   *  {@link IDragSourceMonitor#getItem}.id and your component's id, or similar. Do this if the
   ...
   *  *Note: You may not call {@link IDragSourceMonitor#isDragging} inside this method.*
   *
   ...
   */
  isDragging?(monitor: IDragSourceMonitor<Item, void>): boolean;
   ...
   * want to check {@link IDragSourceMonitor#didDrop} and {@link IDragSourceMonitor#getDropResult} for more
   * details.
   */
  endDrag?(monitor: IDragSourceMonitor<Item, DropResult>): void;
}
